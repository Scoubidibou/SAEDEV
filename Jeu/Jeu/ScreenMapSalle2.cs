...
namespace Jeu
{
    public class ScreenMapSalle2 : GameScreen
    {
        ...
        public ScreenMapSalle2(Game game) : base(game)
        {
        ...
        public override void LoadContent()
        {
            ...
            base.LoadContent();
            //map
            _tiledMap = Content.Load<TiledMap>("SalleDeCour5"); //faudra ajouter le nom de la map
