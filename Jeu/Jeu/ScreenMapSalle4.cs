...
namespace Jeu
{
    public class ScreenMapSalle4 : GameScreen
    {
        ...
        public ScreenMapSalle4(Game game) : base(game)
        {
        }
        ...
        public override void LoadContent()
        {
            ...
            base.LoadContent();
            //map
            _tiledMap = Content.Load<TiledMap>("SalleDeCour7"); //faudra ajouter le nom de la map
